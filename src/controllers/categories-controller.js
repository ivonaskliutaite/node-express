...
const createCategoryNotFoundError = (categoryId) => createNotFoundError(`Recipe with id '${categoryId}' was not found`);
...
const update = async (req, res) => {
  ...
  try {
    ...
    if (updatedCategory === null) throw createCupNotFoundError(categoryId);
